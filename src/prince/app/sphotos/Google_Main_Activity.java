...
public class Google_Main_Activity extends ActivityX {
	...
	public void onCreate(Bundle oldState){
		...
		if (getSupportFragmentManager().findFragmentByTag(TAG) == null) {
			...
			ft.add(prince.app.sphotos.R.id.frame_fb_main_activity, new Google_Main_Fragment(), TAG);
			ft.commit();
		}
		...
		// Initialize camera
		camera = new CameraX(this, Util.GOOGLE_CAMERA_REQUEST, Global.getInstance().createPath(Util.SOCIAL_PHOTOS_PATH));
	}
	
	@Override
	public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == Util.GOOGLE_CAMERA_REQUEST && resultCode == RESULT_OK) {
	...
	protected String getBarTitle() {
		// TODO Auto-generated method stub
		return getResources().getString(R.string.title_google);
	}
